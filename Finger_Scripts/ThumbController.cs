...
public class ThumbController : MonoBehaviour
{
    ...
    int min_Prox_x_angle = -45;
    int max_Prox_x_angle = -15;

    int min_Inter_x_angle = 0;
    int max_Inter_x_angle = 20;

    int min_Distal_x_angle = 0;
    int max_Distal_x_angle = 60;
    ...
    void Start()
    {
        ...
        Inter_pos = GameObject.Find("Right_ThumbIntermediate");
        Distal_pos = GameObject.Find("Right_ThumbDistal");
